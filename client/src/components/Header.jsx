    ...
    return (
        <Navbar className='border-b-2 sticky top-0 z-50 w-full'>
            <Link to="/" className="self-center whitespace-nowrap text-sm sm:text-xl font-semibold dark:text-white">
                <span className="px-2 py-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg text-white">Block
                </span>
                Shield
            </Link>
            ...
            <Navbar.Collapse>
                ...
                <Navbar.Link active={path === "/dashboard?tab=request"} as={"div"}>
